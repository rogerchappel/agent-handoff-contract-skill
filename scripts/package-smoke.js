...
const requiredFiles = ['src', 'scripts', 'fixtures', 'docs', 'SKILL.md', 'README.md', 'LICENSE'];
...
for (const expected of ['src/cli.js', 'src/index.js', 'fixtures/complete.md', 'SKILL.md', 'README.md', 'LICENSE']) {
